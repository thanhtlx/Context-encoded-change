        ...
        for cur_epoch in range(args.start_epoch, int(args.num_train_epochs)):
            ...
            if args.do_eval:
                ...
                if args.save_last_checkpoints:
                    ...
                    print("Save the last model into %s", output_model_file)

                if eval_ppl < best_ppl:
                    not_loss_dec_cnt = 0
                    print("  Best ppl:%s", eval_ppl)
                    print("  " + "*" * 20)
                    ...
                    not_loss_dec_cnt += 1
                    print("Ppl does not decrease for %d epochs", not_loss_dec_cnt)
                ...
                if args.do_eval_bleu:
                    ...
                    if dev_bleu_em > best_bleu_em:
                        ...
                        print("  [%d] Best bleu+em: %.2f (bleu: %.2f, em: %.2f)",
                        ...
                        if args.data_num == -1 or args.always_save_model:
                            ...
                            output_model_file = os.path.join(output_dir, "pytorch_model.bin")
                            torch.save(model_to_save.state_dict(), output_model_file)
                            print("Save the best bleu model into %s", output_model_file)
                    else:
                        not_bleu_em_inc_cnt += 1
                        print("Bleu does not increase for %d epochs", not_bleu_em_inc_cnt)
                        fa.write(
